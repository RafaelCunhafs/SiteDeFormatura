...
<div class="form-horizontal">
	...
	<div class="control-group"><div class="control-label"><?php echo $this->form->getLabel('pagination'); ?></div><div class="controls"><?php echo $this->form->getInput('pagination'); ?></div></div>
...
<div class="form-horizontal">
	...
	<div class="control-group"><div class="control-label"><?php echo $this->form->getLabel('cols'); ?></div><div class="controls"><?php echo $this->form->getInput('cols'); ?> Doesn't make sence in responsive mode</div></div>
</div>
