...
class SmartSlider3Info {
    ...
    public static $version = '3.4.1.5';

    public static $channel = 'stable';

    public static $revision = 'fcae71be8149f6baff6b8c92509cd318a017e565';

    public static $revisionShort = 'fcae71be';

    public static $branch = 'release-3.4.1.5';
