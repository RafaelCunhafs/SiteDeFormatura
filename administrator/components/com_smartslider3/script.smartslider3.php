...
class com_SmartSlider3InstallerScript {
    ...
    private function cleanup() {
        ...
        $updateSites = $db->setQuery("SELECT update_site_id FROM #__update_sites WHERE location LIKE 'https://secure.nextendweb.com/api/api.php?action=joomla_version&platform=joomla&product=smartslider3%'")
                          ->loadAssocList();
