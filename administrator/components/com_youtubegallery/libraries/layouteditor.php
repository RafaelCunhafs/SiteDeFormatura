...
//$document->addCustomTag('<script src="'.$adminpath.'js/layoutwizard.js"></script>');
		...
		function renderEditor($textareacode,$layoutname,&$onPageLoads)
		{
			$index=count($onPageLoads);
							...
							$result='<div style="position:relative;">
								...
								<div class="yg_tip">
								Upgrade to <a href="https://joomlaboat.com/youtube-gallery#pro-version" target="_blank">PRO version</a> to enable this feature.
								</div>
								</div>
';
